...
impl Screen for MainMenuScreen {
    fn init(&mut self, application: &App) {
        let vertex_buffer = Buffer::new(application.clone(), vk::BufferUsageFlags::VERTEX_BUFFER, (size_of::<Vertex>() * 4) as vk::DeviceSize)
            .unwrap();
        vertex_buffer.write([
        ...
        let index_buffer = Buffer::new(application.clone(), vk::BufferUsageFlags::INDEX_BUFFER, (size_of::<u16>() * 6) as vk::DeviceSize)
            .unwrap();
        index_buffer.write([
            0u16,
            1u16,
        ...
        let alpha_buffer = Buffer::new(application.clone(), vk::BufferUsageFlags::UNIFORM_BUFFER, size_of::<f32>() as vk::DeviceSize)
            .unwrap();
